      ...
      <div class="w-full md:flex h-full overflow-auto rounded-xl">
        <div class="flex items-center bg-black w-full">
          <img
            ...
            src="https://picsum.photos/id/239/500/520"
          >
        </div>
        ...
        <div class="md:max-w-[500px] w-full relative">
          <div class="flex items-center justify-between p-3 border-b">
            <div class="flex items-center">
              <img src="https://picsum.photos/id/33/300/320" class="rounded-full w-[38px] h-[38px]">
            ...
            <div class="flex items-center justify-between p-3">
              <div class="flex items-center relative">
                <img
                  ...
                  src="https://picsum.photos/id/53/800/820"
                >
                <div class="ml-14">
                  <span class="font-extrabold text-[15px] mr-2">Name Here</span>
                  <span class="text-[15px] text-gray-900">This is a comment.</span>
                </div>
              </div>
            </div>
