  ...
  <MainLayout>
      ...
      <div class="flex items-center md:justify-between">
        ...
        <label for="fileUser">
          <img
            ...
            src="https://picsum.photos/id/623/200/200"
          >
        </label>
        <input
          id="fileUser"
        ...
        <div class="ml-6 w-full">
          <div class="flex items-center md:mb-8 mb-5">
            ...
            <button class="md:block hidden md:mr-6 p-1 px-4 rounded lg text- font-extrabold bg-gray-100 hover:bg-gray-200">
              Edit Profile
            </button>
          ...
          <div class="md:block hidden">
            <div class="flex items-center text-[18px]">
              ...
              <div class="mr-6">
                <span class="font-extrabold">167</span> followers
              </div>
              <div class="mr-6">
                <span class="font-extrabold">421</span> following
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="md:hidden">
      <div class="w-full flex items-center justify-around border-t border-t-gray-300 mt-8">
        ...
        <div class="text-center p-3">
          <div class="font-extrabold">167</div>
          <div class="text-gray-400 font-semibold -mt-1.5">followers</div>
        </div>
        <div class="text-center p-3">
          <div class="font-extrabold">421</div>
