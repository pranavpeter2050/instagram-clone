...
<template>
  <div class="w-full xl:hover:bg-gray-100 p-2 rounded-full transition duration-300 ease-in-out cursor-pointer">
    <div class="flex items-center">
      ...
      <span class="xl:block hidden text-balck font-extrabold text-[18px] pl-2 mt-0.5">
        {{ iconString }}
      </span>
    </div>
  </div>
